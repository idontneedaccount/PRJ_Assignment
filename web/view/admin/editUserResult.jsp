...
<head>
    ...
    <title>Kết Quả Cập Nhật Người Dùng</title>
...
<body>
    ...
    <div class="container">
        <h2 class="form-title">Kết Quả Cập Nhật Người Dùng</h2>
        <div class="result-section ${user == null ? 'error' : ''}">
            <c:if test="${user == null}">
                <h3>Cập nhật người dùng thất bại.</h3>
            </c:if>
            <c:if test="${user != null}">
                <h3>Cập nhật người dùng thành công:</h3>
